...
// TokenPermissions command implementation
func TokenPermissions() {
	...
	// Construct the command to check token capabilities
	...
	// Test writing a secret to /kv engine
	...
	// Cleanup: Delete the test secret (optional)
